...
func deriveSlot(round *GameRound, seed []byte, fair FairRound, c Config, wager int64) (int64, error) {
	...
	r, err := slot.Spin(wager, func(domain string, n uint32) (uint32, error) {
