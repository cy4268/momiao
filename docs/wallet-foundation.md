...
本节记录 A1 内部账本基础。当前 A2a 已在其上接入只读钱包、显式零值初始化与流水页面，见 [钱包接口](../contracts/wallet-api.md)。资产变更库仍为内部能力；门户不自动执行迁移，也没有充值、兑换或奖励写入入口。
...
本清单原用于 A2 开工前：其中身份核验、独立平台库、受限角色、钱包查询接口/页面已由 A2a 接入；恢复证据需按运行环境独立验收。Master 资料、奖励、充值、quota 划转与游戏仍未开放，整机恢复和容量仍不作完成声明。
