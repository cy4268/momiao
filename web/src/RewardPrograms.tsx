...
export function RewardPrograms({ client, userID, blocked, version, onClaim }: {
    ...
    return <>
        <section className="panel reward-card" aria-labelledby="hourly-title"><div><p className="eyebrow">HOURLY / RESERVE SUPPLY</p><h2 id="hourly-title">小时奖励</h2><RewardArt name="hourglass" /><p className="wallet-amount">100 <small>Reserve</small></p><p className="reward-description">每小时一次 · 不累计补领</p></div><div className="daily-action">
        ...
        <section className="panel reward-card" aria-labelledby="relief-title"><div><p className="eyebrow">RELIEF / LOW-ASSET SUPPORT</p><h2 id="relief-title">低资产救济</h2><RewardArt name="supply" /><p className="wallet-amount">300 <small>Reserve</small></p><p className="reward-description">总资产低于 10 · 冷却 4 小时</p></div><div className="daily-action">
