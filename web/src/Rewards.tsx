...
function RewardsView({ client, userID }: { client: ApiClient; userID: string }) {
    ...
    return <div className="rewards-page"><header className="page-heading"><div><p className="eyebrow">REWARDS / RESERVE SUPPLY</p><h1>奖励中心</h1><p>每日、小时与低资产补给都由你主动领取。</p></div><Link className="button" to="/wallet">查看我的钱包</Link></header>
        <div className="reward-rail"><span>三种固定补给</span><strong>全部进入 Reserve</strong><span>服务端核对时段、冷却与总资产</span></div>
