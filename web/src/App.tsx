...
function Shell({ client, user }: {
    ...
    useEffect(() => { setMenu(false); document.title = `${location.pathname === '/keys' ? '密钥管理' : location.pathname === '/logs' ? '调用记录' : '指挥台'} · momiao`; main.current?.focus(); }, [location.pathname]);
